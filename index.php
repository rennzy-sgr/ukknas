...
<head>
    ...
    <title>Nusa Baca</title>
    <!-- favicon -->
    <link rel="icon" href="images/favicon1.svg" type="image/svg+xml">
	<!-- BOOTSTRAP STYLES-->
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default bg-dark navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand bg-dark" href="index.php">Nusa Baca</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="index.php"><i class="fa fa-dashboard fa-2x"></i>Homepage</a>
                    </li>
                    <li>
