                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                $anggota = $data['nis'];
                                // echo $test;
                                $anggota = $koneksi->query("SELECT * FROM tb_anggota WHERE nis=$anggota");
                                $show = $anggota->fetch_assoc();
                                echo $show['nis'];
                             ?>
                        </td>
                        ...
                        <td>
                            <a href="?page=transaksi&aksi=kembali&id=<?php echo $data['id']; ?>&judul=<?php echo $data['judul']?>" class="btn btn-info" style="width:100px" >Kembali</a>
